  ...
  <div class="main">
    ...
    <div class="tab" id="t-revenue">
      ...
      <div class="action-card" style="max-width:480px">
        ...
        <tr><td>Lifetime</td><td>₦299,999</td><td>Forever</td></tr>
        </tbody></table>
      </div>
    </div>
    ...
    <div class="tab" id="t-actions">
      <div class="action-grid">
        <div class="action-card">
          ...
          <select class="fi" id="g-plan"><option value="monthly">Monthly — ₦9,500</option><option value="yearly">Yearly — ₦90,000</option><option value="lifetime">Lifetime — ₦299,999</option></select>
